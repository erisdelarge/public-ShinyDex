    ...
    $(document).on('click', '.f-name', function(){
        ...
        $.getJSON("https://pokeapi.co/api/v2/pokemon/"+id, function(data) {
            ...
            $.getJSON("https://pokeapi.co/api/v2/pokemon-species/"+id, function(json) {
                ...
                if(evoChain==null){
                    console.log("evochain with null");
                    var evoCard=`<div class="f-evo-line mt-4 pt-2 text-center">
                    <p>Evolution Line:</p>
                    <div class="row justify-content-center my-0 py-0 mx-lg-5 px-lg-5">
                        <div class="p-0 col-2"><span class=""><a href=""><img class="img-fixed f-pmn-evosprite" src="" alt="base sprite"></a></span><span class="d-flex flex-column"><small class="text-muted f-evo-index-number">#`+padPokemonNumber(data.id, 4)+`</small><span class="f-evo-sprite-name">`+nameUC+`</span></span></div>                                    
                    </div>
                </div>`;
                }else{
                    ...
                    $.ajax({
                        ...
                        success: function (json) {
                            evoChainUrlNumber=evoChainUrl.replace("https://pokeapi.co/api/v2/evolution-chain/", "");
                            evoChainUrlN=evoChainUrlNumber.replace("/", "");
