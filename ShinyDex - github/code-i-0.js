    ...
    myArray.push(nomi);
        ...
        muteBtn='<a class="f-orms '+dropBtn+'" href="">'+forms+'</a>';
            ...
            muteBtn='<a class="f-orms '+dropBtn+'" href="">'+forms+'</a>';
                ...
                gender= "mo";
            } else if (i==99 || i==100 || i==119 || i==120 || i==131 || i==136 || i==150 || i==232 || i>=242 && i<=244 || i>=248 && i<=250 || i==291 || i==232 || i==336 || i==337 || i==342 || i==343 || i==373 || i==374 || i>=376 && i<=378 || i==384 || i==435|| i==436 || i==461|| i==473|| i>=479 && i<=483 || i==485 || i>=488 && i<=490 || i==493 || i>=598 && i<=600 || i==614|| i==621|| i==622 || i>=637 && i<=639 || i==642 || i==643 || i==702|| i==716 || i==720 || i==780 || i>=784 && i<=798 || i>=801 && i<=807 || i==853 || i==854 || i==869 || i>=879 && i<=882 || i>=893 && i<=896) {
                gender= "uk";
            }
