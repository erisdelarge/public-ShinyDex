        ...
        var gender = "mf";
         ...
         nome='<a class="f-name" href="">'+ myArray[i]+'</a>';
            ...
            if (i==3) {
                ...
                modalbody= modalcol+cardop+'003_000_md_n_00000000_f_n'+img_s +'003_000_md_n_00000000_f_r'+spans+male+cardcl+div_+modalcol+cardop+'0003_000_fd_n_00000000_f_n'+img_s +'0003_000_fd_n_00000000_f_r'+spans+fem+cardcl+div_+modalcol+cardop+'0003_001_mf_n_00000000_f_n'+img_s+'0003_001_mf_n_00000000_f_r'+spans+mega+cardcl+div_+modalcol+cardop+'0003_000_mf_g_00000000_f_n'+img_s+'0003_000_mf_g_00000000_f_r'+spans+giga+cardcl+div_;
                dropmenu= div+cardop+'0003_000_fd_n_00000000_f_n'+img_s +'0003_000_fd_n_00000000_f_r'+spans+fem+cardcl+cardop+'0003_001_mf_n_00000000_f_n'+img_s+'0003_001_mf_n_00000000_f_r'+spans+mega+cardcl+cardop+'0003_000_mf_g_00000000_f_n'+img_s+'0003_000_mf_g_00000000_f_r'+spans+giga+cardcl+div_;
                ...
                gender= "md";
                    forms= "male";
                    dropBtn= 'f-dropdown" data-bs-toggle="modal" data-bs-target="#ex'+myArray[i]+'Modal';
                    modalbody=cardop+'0195_000_md_n_00000000_b_n'+img_s +'0195_000_md_n_00000000_b_r'+spans+male+cardcl+cardop+'0195_000_fd_n_00000000_b_n'+img_s +'0195_000_fd_n_00000000_b_r'+spans+fem+cardcl;
                    dropmenu= div+modalbody+div_;
                modallo= '<div class="modal fade" id="ex'+myArray[i]+'Modal" tabindex="-1"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h5 class="modal-title f-modal-tit" id="exampleModalLabel">'+myArray[i]+' forms</h5><button type="button" class="btn-close f-modalcloser" data-bs-dismiss="modal" aria-label="Close"></button></div><div class="modal-body d-flex">'+modalbody+'</div></div></div></div>';
                muteBtn='<a class="f-orms '+dropBtn+'" href="">'+forms+dropmenu+'</a>';
            } else if (i==198){
                ...
                dropmenu= div+cardop+'0201_001_uk_n_00000000_f_n'+img_s +'0201_001_uk_n_00000000_f_r'+spans+'B'+cardcl+cardop+'0201_002_uk_n_00000000_f_n'+img_s +'0201_002_uk_n_00000000_f_r'+spans+'C'+cardcl+cardop+'0201_003_uk_n_00000000_f_n'+img_s +'0201_003_uk_n_00000000_f_r'+spans+'D'+cardcl+div_;
             ...
             else if (i==256 || i==257 || i==267 || i==269 || i==272 || i==274 || i==275 || i==307 || i==308 || i==315 || i==316 || i==317 || i==322 || i==323 || i==332 || i==350 || i==369 || i>=396 && i<=405 || i==407 || i==415 || i>=417 && i<=419 || i==424 || i==443 || i==444 || i==445 || i==449 || i==450 || i==453 || i==454 || i==456 || i==457 || i>=459 && i<=461 || i==464 || i==465 || i==473 || i==521 || i==592 || i==593 || i==668) {
                gender= "md";
                forms= "male";
                ...
                gender= "uk";
            } else if ( i==254 || i==260 || i==263 || i==264 || i==282 || i==302 || i==303 || i==306 || i==310 || i==319 || i==327 || i==334 || i==351 || i==354 || i==359 || i==362 || i==373 || i==428 || i==448 || i==531 || i==554 || i==555 || i==562 || i==569 || i==618 || i==658 || i==812 || i==870 || i==815 || i==818 || i==823 || i==826 || i==834 || i==839 || i==841 || i==844 || i==845 || i==851 || i==879 || i==884){
                forms= "standard";
